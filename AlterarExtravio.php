...
<div class="container-fluid">
    ...
    $results = mysqli_query($db, "SELECT * FROM tb_extravio WHERE id='$id'");
    while ($linha = mysqli_fetch_array($results)) {
        ...
        $alterar_Peca = $linha['Peca'];
        $alterar_CustoEstimado = $linha['CustoEstimado'];
    }
    ?>
    <div class="centro">
        <form role="form" method="post" action="FunctionsExtravio.php?escolha=alterar&id= <?php echo $alterar_id?>">
            ...
            <div class="row col-md-12">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="InputPeca" name="InputPeca" value="<?php echo $alterar_Peca ?>" >
                </div>
            </div>
            <div class="row col-md-12">
                <div class="form-group col-md-12">
                    <label for="InputCustoEstimado">Custo Estimado</label>
                    <input type="text" class="form-control" id="InputCustoEstimado" name="InputCustoEstimado" value="<?php echo $alterar_CustoEstimado ?>">
