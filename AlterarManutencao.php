...
<div class="container-fluid">
    ...
    $results = mysqli_query($db, "SELECT * FROM tb_manutencao WHERE id='$id'");
    while ($linha = mysqli_fetch_array($results)) {
        ...
        $alterar_Custo = $linha['Custo'];
    }
    ?>
    <div class="centro">
        <form role="form" method="post" action="FunctionsManutencao.php?escolha=alterar&id= <?php echo $alterar_id?>">
            ...
            <div class="row col-md-12">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="InputCusto" name="InputCusto" value="<?php echo $alterar_Custo ?>">
